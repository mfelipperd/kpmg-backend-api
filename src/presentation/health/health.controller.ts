...
export class HealthController {
  ...
  @ApiOperation({ 
    ...
    description: 'Verifica o status de saúde da aplicação, incluindo conectividade com banco de dados e recursos do sistema'
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({ 
    ...
    description: 'Verificação simples de saúde da aplicação - ideal para load balancers'
  })
  @ApiResponse({
    status: 200,
